...
theme.bg_focus      = "#1A0026" 
theme.bg_urgent     = "#FF00FF" 
theme.bg_minimize   = "#330033" 
...
--theme.wibar_bg = "#0A0A0A"   -- Fondo negro profundo
--theme.wibar_fg = "#FF00FF"   -- Texto en morado neón

theme.wibar_border_width = 1
theme.wibar_border_color = "#FF00FF"
...
theme.wallpaper = "/home/jzak/.config/awesome/default/background.png"
